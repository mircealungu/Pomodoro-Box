...
2. Open the Preferences of Pomodoro Desktop. Go to the Script tab and paste the following script for the End event (I pasted using the mouse; the keyboard shortcut did not work):
